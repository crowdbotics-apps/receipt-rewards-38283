"""
Django settings for receipt_rewards_38283 project.
...
ROOT_URLCONF = 'receipt_rewards_38283.urls'
...
WSGI_APPLICATION = 'receipt_rewards_38283.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "receipt_rewards_38283 API",
    "DESCRIPTION": "API documentation for receipt_rewards_38283 App",
    "VERSION": "v1",
}
